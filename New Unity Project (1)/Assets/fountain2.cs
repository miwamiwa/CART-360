...
public class fountain2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        osc.SetAddressHandler("/fountain2X", MaxCallBackX);
        osc.SetAddressHandler("/fountain2Z", MaxCallBackZ);
        osc.SetAddressHandler("/fountain2Y", MaxCallBackY);
        osc.SetAddressHandler("/fountain2S", MaxCallBackS);
        osc.SetAddressHandler("/fountain2R", MaxCallBackR);
        osc.SetAddressHandler("/fountain2A", MaxCallBackA);
    }
